 ...
 */
abstract class AbstractConfig(private val prefix: String) : WithLogging {
  ...
  protected class PropertyDelegate<T>(
    ...
    override fun getValue(
      ...
      return value ?: run {
        ...
        val envName = arrayOf(prefix, property.name).joinToString("_").replace(REGEXP_ENV_NAME_UNDERSCORE, "_$1").toUpperCase()
